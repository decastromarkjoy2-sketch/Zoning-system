...
function Box({
  ...
  return (
    <div
      className={`border border-black p-1 min-h-[28px] ${wide ? "col-span-2" : ""}`}
    >
    ...
    <div className="space-y-4 max-w-5xl">
      <div className="flex items-center gap-4 no-print">
        ...
        <h1 className="text-lg font-semibold flex-1">
          Generated Forms — {record.reference_number}
        </h1>
        <label className="flex items-center gap-2 text-sm">
          <span className="text-muted-foreground whitespace-nowrap">Coordinator:</span>
          <input
            type="text"
            value={coordinator}
            onChange={(e) => setCoordinator(e.target.value)}
            className="border rounded px-2 py-1 text-sm w-52 bg-background"
          />
        </label>
        ...
        <Tabs defaultValue="form1">
          ...
          <TabsContent value="form1">
            <div className="printable-form">
              <div
                id="form1"
                className="printable-form-sheet bg-white text-black border border-gray-300 p-6 font-serif print:border-none print:shadow-none"
              ...
              >
                  ...
                  <div className="flex justify-between items-start mt-2">
                    ...
                    <div className="text-left text-[9px] space-y-0.5 w-48">
                      ...
                      <div className="flex gap-1">
                        ...
                        <span className="border-b border-black flex-1 min-w-[80px]">
                          {fmtDate(record.date_of_payment)}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 flex-1">
                      {logoUrl ? (
                        <img
                          src={logoUrl}
                          alt="LGU Logo"
                          className="form-header-logo h-20 w-20 object-contain"
                        />
                      ) : (
                        <div className="h-20 w-20 flex items-center justify-center rounded-full border-2 border-black text-[8px] font-bold text-center">
                          LGU
                        </div>
                      )}
                ...
                <div className="border-t-2 border-b-2 border-black text-center py-1 my-2">
                  <p className="text-[11px] font-bold tracking-wide">
                    APPLICATION FOR LOCATIONAL CLEARANCE / CERTIFICATE OF ZONING
                    COMPLIANCE
                  </p>
                </div>
                ...
                <div className="grid grid-cols-2 gap-0 text-[9px]">
                  ...
                  <div className="border border-black p-1">
                    <div className="font-bold mb-0.5">
                      3. Address &amp; Tel. No. of Applicant
                    </div>
                    <div className="border-b border-black min-h-[18px]">
                      {record.address}
                      {record.owner_contact
                        ? ` / Tel: ${record.owner_contact}`
                        : ""}
                    </div>
                  </div>
                  <div className="border border-black p-1">
                  ...
                  <div className="border border-black p-1">
                    <div className="font-bold mb-0.5">
                      10. Project Scope{" "}
                      <span className="font-normal">(In Square Meters)</span>
                    </div>
                    <div className="flex gap-4">
                      <div>
                        <span className="font-bold">Lot Area:</span>{" "}
                        <span>
                          {record.land_area
                            ? `${fmtNum(record.land_area)} sq.m.`
                            : "_____ sq.m."}
                        </span>
                      </div>
                      <div>
                  ...
                  <div className="border border-black p-1 col-span-2">
                    ...
                    <div className="border-b border-black min-h-[18px]">
                      {ZONE_LABEL[record.zone_type] ??
                        record.zone_type.toUpperCase()}
                    </div>
                  </div>
                  ...
                  <div className="border border-black p-1 col-span-2">
                    <div className="font-bold mb-1">
                      18. Preferred mode of release of decision:
                    </div>
                    <div className="flex gap-6">
                      <label className="flex items-center gap-1">
                        <span className="border border-black w-3 h-3 flex items-center justify-center text-[8px]">
                          {record.release_mode === "pickup" ? "✓" : ""}
                        </span>
                        <span>Pick-up</span>
                      </label>
                      <label className="flex items-center gap-1">
                        <span className="border border-black w-3 h-3 flex items-center justify-center text-[8px]">
                          {record.release_mode === "mail" ? "✓" : ""}
                        </span>
                        <span>Mail</span>
                      </label>
                    </div>
                ...
                <div className="border border-black p-2 mt-1 grid grid-cols-2 gap-4 text-[8px]">
                  <div>
                    <div className="font-bold mb-1">
                      19. Signature Over Printed Name of Applicant
                    </div>
                    <p>
                      I hereby certify to the best of my knowledge, belief &amp;
                      information that these are true &amp; correct statements I
                      made &amp; I declare under the penalties of perjury if
                      ever I made false statements, that this application has
                      been in good faith verified by me.
                    </p>
                    <div className="mt-4 border-t border-black pt-1 text-center">
                      {record.owner_name}
                      <br />
                      <span className="text-[7px]">Applicant</span>
                    </div>
                  </div>
                  <div>
                    <div className="font-bold mb-1">
                      19. Signature Over Printed Name of Authorized
                      Representative
                    </div>
                    <p>
                      I hereby certify to the best of my knowledge, belief &amp;
                    ...
                    <div className="mt-4 border-t border-black pt-1 text-center">
                      ...
                      <br />
                      <span className="text-[7px]">Representative</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-2 text-[8px] border border-black p-2">
                  ...
                  <p className="mt-1">
                    ...
                    ____________, __________ in the Municipality of ________,
                    Surigao del Sur, affiant exhibited to me his/her Community
                    Tax No. ________________, issued at ________________, on
          ...
          <TabsContent value="form2">
            <div className="printable-form">
              <div
                id="form2"
                className="printable-form-sheet bg-white text-black border border-gray-300 p-6 font-serif print:border-none"
                style={{ fontFamily: "Times New Roman, serif" }}
              >
                {/* Header */}
                <div className="mb-3">
                ...
                <div className="grid grid-cols-2 gap-0 text-[9px] mb-1">
                  ...
                  <div className="border border-black p-1">
                    <span className="font-bold">Date of Issued:</span>{" "}
                    {fmtDate(record.date_issued)}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-0 text-[9px] mb-1">
                  <div className="border border-black p-1">
                    ...
                    <div className="border-b border-black min-h-[16px]">
                      {record.owner_name}
                    </div>
                  </div>
                  <div className="border border-black p-1">
                ...
                <div className="grid grid-cols-2 gap-0 text-[9px] mb-1">
                  ...
                  <div className="border border-black p-1">
                    ...
                    <div
                      className={`text-[12px] font-bold mt-1 ${record.status === "approved" ? "text-green-700" : record.status === "rejected" ? "text-red-700" : "text-yellow-700"}`}
                    >
      ...
      <div className="print-only-forms">
        ...
        <div className="print-form1-break">
          <div
            className="printable-form-sheet bg-white text-black border border-gray-300 p-6 font-serif"
            style={{ fontFamily: "Times New Roman, serif" }}
          >
            <div className="mb-2">
              <p className="text-center text-[9px]">
            ...
            <div className="border border-black p-2 mt-1 grid grid-cols-2 gap-4 text-[8px]">
              <div>
                ...
                <p>
                  I hereby certify to the best of my knowledge, belief &amp;
                  information that these are true &amp; correct statements I
                  made &amp; I declare under the penalties of perjury if ever I
                  made false statements, that this application has been in good
                  faith verified by me.
                </p>
                <div className="mt-4 border-t border-black pt-1 text-center">
                  {record.owner_name}
                  <br />
              ...
              <div>
                <div className="font-bold mb-1">
                  19. Signature Over Printed Name of Authorized Representative
                </div>
                <p>
                  I hereby certify to the best of my knowledge, belief &amp;
                  information that these are true &amp; correct statements I
                ...
                <div className="mt-4 border-t border-black pt-1 text-center">
                  {record.authorized_rep_name ?? "___________________________"}
                  <br />
                  <span className="text-[7px]">Representative</span>
                </div>
              </div>
            ...
            <div className="mt-2 text-[8px] border border-black p-2">
              ...
              <p className="mt-1">
                SUBSCRIBED AND SWORN TO before me this ______ day of
                ____________, __________ in the Municipality of ________,
                Surigao del Sur, affiant exhibited to me his/her Community Tax
                No. ________________, issued at ________________, on
                _____________________________.
              </p>
              <div className="grid grid-cols-2 mt-2 gap-2">
                <div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-0 text-[9px] mb-1">
              ...
              <div className="border border-black p-1">
                <div className="font-bold">Area &amp; Location</div>
                <div className="border-b border-black min-h-[16px]">
                  {record.land_area ? `${fmtNum(record.land_area)} sq.m.` : ""}
                </div>
                <div className="min-h-[16px] mt-1">
                  {record.barangay}
                  {record.address ? `, ${record.address}` : ""}
      ...
      <style>{`
        ...
        @media print {
          @page {
            /* Set exact dimensions for Long Bond */
            size: 8.5in 13in;
            /* Set margin to 0 to allow content to take full space */
            margin: 0 !important;
          }
          ...
          .print-only-forms, .print-only-forms * {
          ...
          /* Force page break between the two forms */
          .print-form1-break {
          ...
          .printable-form-sheet {
            width: 100% !important; /* Forces it to match the page width */
            min-height: 100vh !important; /* Ensures it covers the full page height */
            margin: 0 !important;
            padding: 0.25in !important; /* Added a tiny bit of internal padding so the text isn't stuck to the paper edge */
